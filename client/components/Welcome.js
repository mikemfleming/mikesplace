	...
	return (
	  <div className="welcome">
		  ...
		  <div className="content-text">
		  	<h1>Hey, there!</h1>
		  	<p>
			  	I am a Software Engineer based out of Austin, Texas. I have 
			  	experience with mobile optimized web apps and large scale
		  	...
		  	<p>
			  	I've workled on the front and back end using 
			  	technologies like React, Angular, Backbone, Mithril, jQuery, 
			  	Node.js, Express, and PostgreSQL. I made this particular website 
			  	from scratch with React, Express, and Browserify!
				</p>
				<p>
