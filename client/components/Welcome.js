	...
	return (
	  <div className="welcome">
		  ...
		  <div className="content-text">
		  	<h1>Hey, there!</h1>
		  	<p>
		  		My name is Mike and I am a software engineer and teacher based out of Austin.
		  		I'm also an adventurer and photographer. Feel free to check out my 
		  		portfolio <a href="http://mikemfleming.tumblr.com/">here</a>.  
		  	</p>
		  	<p>
			...
			<p>
				...
				feel the same let's get together! View samples of my work below 
				and shoot me an email while you're at it.</em>
			</p>
		  </div>
